...
\begin{figure}[htbp]
\centering
\includegraphics[width=\columnwidth]{fig_dssat_obs_pred.png}
...
\begin{figure}[htbp]
\centering
\includegraphics[width=\columnwidth]{fig_dssat_erro_ano.png}
...
\begin{figure}[htbp]
\centering
\includegraphics[width=\columnwidth]{fig_validation_learning_curve.png}
...
\caption{Resumo da avaliação final da política PPO com DSSAT calibrado. Produtividade, irrigação e MAE são apresentados em kg ha$^{-1}$, mm e kg ha$^{-1}$, respectivamente.}
\label{tab:ppo_resumo_final}
\resizebox{\columnwidth}{!}{%
\begin{tabular}{lrrrrrr}
\hline
Conj. & Recomp. & Prod. & Irrig. & MAE & MAPE & $n$ \\
      & média   & média & média  &     & (\%) & \\
\hline
...
\scriptsize
\setlength{\tabcolsep}{3pt}
\caption{Resultados anuais da política PPO no conjunto de validação. Produtividade, observado e erro são apresentados em kg ha$^{-1}$; irrigação e chuva em mm.}
\label{tab:ppo_validacao}
\resizebox{\columnwidth}{!}{%
\begin{tabular}{rrrrrrr}
\hline
Ano & Plantio & Prod. & Obs. & Erro & Irrig. & Chuva \\
\hline
...
\scriptsize
\setlength{\tabcolsep}{3pt}
\caption{Resultados anuais da política PPO no conjunto de teste. Produtividade, observado e erro são apresentados em kg ha$^{-1}$; irrigação e chuva em mm.}
\label{tab:ppo_teste}
\resizebox{\columnwidth}{!}{%
\begin{tabular}{rrrrrrr}
\hline
...
\begin{figure}[htbp]
\centering
\includegraphics[width=\columnwidth]{fig_ppo_obs_pred.png}
...
\begin{figure}[htbp]
\centering
\includegraphics[width=\columnwidth]{fig_ppo_yield_dist.png}
...
\begin{figure}[htbp]
\centering
\includegraphics[width=\columnwidth]{fig_ppo_vs_baselines_reward.png}
...
\begin{figure}[htbp]
\centering
\includegraphics[width=\columnwidth]{fig_ppo_yield_water_tradeoff.png}
